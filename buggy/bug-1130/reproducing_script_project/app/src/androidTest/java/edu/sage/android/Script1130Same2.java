...
public class Script1130Same2 {
    ...
    public void scriptSame1130_2() {
        ...
        List<UiObject2> podcasts = mDevice.wait(Until.findObjects(By.res(BASIC_SAMPLE_PACKAGE,"txtvTitle")),2000);
        podcasts.get(1).click();
        ...
        open = mDevice.wait(Until.findObject(By.text("Episodes")),2000);
        open.click();
        ...
        mDevice.swipe(500,500,1200,500,50);
        ...
        List<UiObject2> check = mDevice.wait(Until.findObjects(By.res(BASIC_SAMPLE_PACKAGE, "container")), 2000);
