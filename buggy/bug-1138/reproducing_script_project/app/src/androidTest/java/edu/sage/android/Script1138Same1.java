...
public class Script1138Same1 {
    ...
    @Test
    public void scriptSame1138_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.text("Permissions required")), 2000));
    }
