        ...
        public class Script114Same1 {
            ...
            @Test
            public void scriptSame114_1() throws IOException, UiObjectNotFoundException, RemoteException {
                ...
                assertNotNull(mDevice.wait(Until.findObject(By.text("Select text")), 2000));
