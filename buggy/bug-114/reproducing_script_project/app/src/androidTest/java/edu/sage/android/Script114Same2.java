        ...
        public class Script114Same2 {
            ...
            @Test
            public void scriptSame114_2() throws IOException, UiObjectNotFoundException, RemoteException {
                ...
                assertNull(mDevice.wait(Until.findObject(By.text("Select text")), 2000));
