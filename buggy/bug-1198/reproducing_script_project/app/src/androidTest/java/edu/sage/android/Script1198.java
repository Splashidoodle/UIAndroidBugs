...
public class Script1198 {
    ...
    public void testScript1198() {
        ...
        UiObject2 nav = mDevice.wait(Until.findObject(By.desc("Open navigation drawer")), 2000);
        nav.click();

        view = mDevice.wait(Until.findObject(By.text("View Files")), 2000);
        view.click();

        pdf = mDevice.wait(Until.findObject(By.text("abc_encrypted2.pdf")), 2000);
        assertNotNull(pdf);
    }
