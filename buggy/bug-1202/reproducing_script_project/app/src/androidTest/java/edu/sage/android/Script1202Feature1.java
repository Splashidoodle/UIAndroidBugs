...
public class Script1202Feature1 {
    ...
    @Test
    public void scriptFeature1202_1() {
        ...
        UiObject2 imageNum = mDevice.wait(Until.findObject(By.text("Showing 2 of 2")),2000);
        assertNotNull(imageNum);
