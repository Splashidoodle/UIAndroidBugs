...
public class Script1205Same1 {
    ...
    public void scriptSame1205_1() {
        ...
        UiObject2 history = mDevice.wait(Until.findObject(By.text("History")), 2000);
        history.click();
        ...
        UiObject2 home = mDevice.wait(Until.findObject(By.text("Create new PDF")), 2000);
        assertNotNull(home);
