...
public class Script130Feature1 {
    ...
    @Test
    public void scriptFeature130_1() throws UiObjectNotFoundException {
        //Click Next
        mDevice.findObject(new UiSelector().resourceId("org.shadowice.flocke.andotp.dev:id/mi_button_next")).click();
        //Click Next
        mDevice.findObject(new UiSelector().resourceId("org.shadowice.flocke.andotp.dev:id/mi_button_next")).click();
        assertNotNull(mDevice.findObject(By.text("Enter new password")));
