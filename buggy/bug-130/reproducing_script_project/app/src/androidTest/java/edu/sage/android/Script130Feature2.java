...
public class Script130Feature2 {
    ...
    @Test
    public void scriptFeature130_2() throws UiObjectNotFoundException {
        //Click Next
        ...
        //Click on PIN
        mDevice.findObject(new UiSelector().text("PIN")).click();

        assertNotNull(mDevice.findObject(By.text("Enter new PIN")));
