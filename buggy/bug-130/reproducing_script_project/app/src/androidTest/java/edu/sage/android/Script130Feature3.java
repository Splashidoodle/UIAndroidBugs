...
public class Script130Feature3 {
    ...
    @Test
    public void scriptFeature130_3() throws UiObjectNotFoundException {
        //Click Next
        ...
        assertNotNull(mDevice.findObject(By.text("Please set a password to continue!")));
