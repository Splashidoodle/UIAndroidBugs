...
public class Script130Same1 {
    ...
    @Test
    public void scriptSame130_1() throws UiObjectNotFoundException {
        //Click Next
        mDevice.findObject(new UiSelector().resourceId("org.shadowice.flocke.andotp.dev:id/mi_button_next")).click();
        //Click password/pin
        mDevice.findObject(new UiSelector().text("Password / PIN")).click();
        //Click Android KeyStore
        mDevice.findObject(new UiSelector().text("Android KeyStore")).click();
        //Click Next
        mDevice.findObject(new UiSelector().resourceId("org.shadowice.flocke.andotp.dev:id/mi_button_next")).click();
        assertNotNull(mDevice.findObject(By.textContains("Android KeyStore")));
