...
public class Script136Feature1 {
    ...
    @Test
    public void scriptFeature136_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertNull(mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE ,"compose_top_comment")), 2000));
    }
