...
public class Script136Feature2 {
    ...
    @Test
    public void scriptFeature136_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        UiObject2 submit = mDevice.wait(Until.findObject(By.text("Submit")), 2000);
        submit.click();

        mDevice.wait(Until.findObject(By.text("Title")), 2000).setText("a");
        mDevice.wait(Until.findObject(By.text("URL")), 2000).setText("a");
        mDevice.wait(Until.findObject(By.text("Text")), 2000).setText("a");

        mDevice.pressBack();
        UiObject2 discard = mDevice.wait(Until.findObject(By.text("Cancel")),2000);
        discard.click();
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE ,"compose_top_comment")), 2000));
    }
