...
public class Script136Same2 {
    ...
    @Test
    public void scriptSame136_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertNull(mDevice.wait(Until.findObject(By.textContains("Commenting on:")), 2000));
    }
