...
public class Script1441Same1 {
    ...
    @Test
    public void scriptSame1441_1() throws UiObjectNotFoundException, IOException {
        // Setup GUI action
        // Click "dismiss"
        ...
        uiDevice.findObject(new UiSelector().className("android.widget.EditText").instance(1)).click();
        // Clear longitude
        uiDevice.findObject(new UiSelector().className("android.widget.EditText").instance(1)).clearTextField();
        // Click back
        uiDevice.pressBack();
        // Click tick
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();

        UiObject la = uiDevice.findObject(new UiSelector().textContains("0.0"));
        UiObject lo = uiDevice.findObject(new UiSelector().textContains("0.0"));
