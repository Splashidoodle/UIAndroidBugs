...
public class Script1445Same1 {
    ...
    @Test
    public void scriptSame1445_1() throws UiObjectNotFoundException, IOException {
        // Setup GUI actions
        // Click "ok"
        ...
        UiObject2 trip = uiDevice.wait(Until.findObject(By.res(PACKAGE_NAME,"title_text_view")), 2000);
        assertNotNull(trip);
    }
