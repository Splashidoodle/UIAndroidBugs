...
public class Script1445Same4 {
    ...
    @Test
    public void scriptSame1445_4() throws UiObjectNotFoundException, IOException {
        // Setup GUI actions
        // Click "ok"
        ...
        // Click day
        uiDevice.findObject(new UiSelector().text("3")).click();
        // Click "ok"
        uiDevice.findObject(new UiSelector().text("OK")).click();
        // Click tick
        ...
        uiDevice.findObject(new UiSelector().clickable(true).instance(3)).click();
        // Click day
        uiDevice.findObject(new UiSelector().text("2")).click();
        // Click "ok"
        uiDevice.findObject(new UiSelector().text("OK")).click();
        // Click tick
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();

        UiObject2 error = uiDevice.wait(Until.findObject(By.text("Error")), 2000);
        assertNotNull(error);
    }
