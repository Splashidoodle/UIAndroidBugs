...
public class Script1446Feature1 {
    ...
    @Test
    public void scriptFeature1446_1() throws UiObjectNotFoundException, IOException {
        // Setup GUI actions
        // Click menu
        ...
        assert(uiDevice.findObject(new UiSelector().text("test")).exists() && uiDevice.findObject(new UiSelector().text("test2")).exists());
    }
