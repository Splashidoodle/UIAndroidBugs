...
public class Script1446Feature2 {
    ...
    @Test
    public void scriptFeature1446_2() throws UiObjectNotFoundException, IOException {
        // Setup GUI actions
        // Click menu
        ...
        // Click delete
        uiDevice.findObject(new UiSelector().resourceId(PACKAGE_NAME + ":id/more_info_button")).click();
        ...
        assertFalse(uiDevice.findObject(new UiSelector().text("test")).exists());
    }
