...
public class Script1446Same1 {
    ...
    @Test
    public void scriptSame1446_1() throws UiObjectNotFoundException, IOException {
        // Setup GUI actions
        // Click menu
        ...
        assert(uiDevice.findObject(new UiSelector().text("Error")).exists());
