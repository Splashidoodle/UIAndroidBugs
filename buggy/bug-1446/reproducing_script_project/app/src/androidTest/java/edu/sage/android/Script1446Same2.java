...
public class Script1446Same2 {
    ...
    @Test
    public void scriptSame1446_2() throws UiObjectNotFoundException, IOException {
        // Setup GUI actions
        // Click menu
        ...
        // Type "test"
        uiDevice.findObject(new UiSelector().className("android.widget.EditText")).legacySetText("a");
        ...
        // Clear text
        uiDevice.findObject(new UiSelector().className("android.widget.EditText")).clearTextField();
        // Enter New Name
        uiDevice.findObject(new UiSelector().className("android.widget.EditText")).legacySetText("newName");
        // Click back
        uiDevice.findObject(new UiSelector().resourceId(PACKAGE_NAME + ":id/back_button")).click();

        assertFalse(uiDevice.findObject(new UiSelector().text("newName")).exists());
