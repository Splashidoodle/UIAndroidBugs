...
public class Script1563Feature2 {
    ...
    @Test
    public void scriptFeature1563_2() throws UiObjectNotFoundException {
        // Setup GUI actions
        // Click unlock
        ...
        UiObject2 menu = uiDevice.wait(Until.findObject(By.desc("Open navigation drawer")), 2000);
        menu.click();

        UiObject2 settings = uiDevice.wait(Until.findObject(By.text("Settings")), 2000);
        settings.click();

        settings = uiDevice.wait(Until.findObject(By.text("General")), 2000);
        settings.click();
        ...
        uiDevice.swipe(560, 1450, 560, 500, 10);
        ...
        UiObject2 sort = uiDevice.wait(Until.findObject(By.text("File sort param")), 2000);
        sort.click();

        sort = uiDevice.wait(Until.findObject(By.text("Date")), 2000);
        sort.click();
        ...
        assertNotNull(uiDevice.findObject(By.res(PACKAGE_NAME, "fileView")));
