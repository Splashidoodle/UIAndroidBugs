...
public class Script160 {
    ...
    public void testScript160() {
        ...
        UiObject2 Default = mDevice.wait(Until.findObject(By.text( "Default")),2000);
        Default.click();
        try {
            TimeUnit.SECONDS.sleep(2);
        } catch (InterruptedException e) {
        ...
        UiObject2 Whiteboard = mDevice.wait(Until.findObject(By.text( "Enable whiteboard")),2000);
        Whiteboard.click();

        UiObject2 Touch = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "touch_layer")),2000);
        Touch.click();
        mDevice.drag(300,300, 600, 600, 1);
        try {
            TimeUnit.SECONDS.sleep(2);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        UiObject2 Undo = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "action_undo").clazz("android.widget.TextView")),2000);
        Undo.click();
        Undo.click();
        try {
            TimeUnit.SECONDS.sleep(2);
        ...
        mDevice.swipe(300,300, 500, 900, 20);
        ...
        //since we drew on the board again, checkUndo should be longClickable(white instead of gray)
        UiObject2 checkUndo = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "action_undo").clazz("android.widget.TextView")),2000);
        assertNotNull(checkUndo);
        assert(!checkUndo.isLongClickable());
