...
public class Script160Feature2 {
    ...
    @Test
    public void scriptFeature160_2() {
        ...
        mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "action_flag")), 2000).click();
        assertNotNull(mDevice.wait(Until.findObject(By.text("Orange flag")), 2000));
