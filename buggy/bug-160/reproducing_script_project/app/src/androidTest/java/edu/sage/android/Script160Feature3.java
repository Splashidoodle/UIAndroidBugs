...
public class Script160Feature3 {
    ...
    @Test
    public void scriptFeature160_3() {
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "action_hide_whiteboard")), 2000));
