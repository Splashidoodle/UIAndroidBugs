...
public class Script1640Feature1 {
    ...
    @Test
    public void scriptFeature1640_1() throws UiObjectNotFoundException {
        ...
        assertNotNull(uiDevice.wait(Until.findObject(By.res(PACKAGE_NAME, "fab")), 2000));
    }
