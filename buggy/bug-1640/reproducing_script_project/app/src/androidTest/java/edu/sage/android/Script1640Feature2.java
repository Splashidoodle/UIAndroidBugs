...
public class Script1640Feature2 {
    ...
    @Test
    public void scriptFeature1640_2() throws UiObjectNotFoundException {
        ...
        //contact button still exists
        uiDevice.wait(Until.findObject(By.res(PACKAGE_NAME, "fab")), 2000).click();

        assertNotNull(uiDevice.wait(Until.findObject(By.text("Contact us on GitHub")), 2000));
    }
