...
public class Script1640Feature3 {
    ...
    @Test
    public void scriptFeature1640_3() throws UiObjectNotFoundException {
        ...
        uiDevice.wait(Until.findObject(By.desc("Navigate up")), 2000).click();

        assertNotNull(uiDevice.wait(Until.findObject(By.text("Trainings Schedule")), 2000));
    }
