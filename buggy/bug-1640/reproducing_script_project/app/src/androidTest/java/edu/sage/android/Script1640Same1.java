...
public class Script1640Same1 {
    ...
    @Test
    public void scriptSame1640_1() throws UiObjectNotFoundException {
        ...
        //page is still called info
        assertNotNull(uiDevice.wait(Until.findObject(By.desc("Info")), 2000));
    }
