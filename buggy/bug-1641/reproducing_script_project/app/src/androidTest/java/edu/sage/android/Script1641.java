...
public class Script1641 {
    ...
    @Test
    public void testScript1641() throws UiObjectNotFoundException {
        // Setup GUI actions
        // Click plus
        ...
        assert(trainingCheck.getText().contains("Trainings Type"));
        assert(trainingCheck.getText().contains("strength_endurance"));
