...
public class Script1641Feature1 {
    ...
    @Test
    public void scriptFeature1641_1() throws UiObjectNotFoundException {
        // Setup GUI actions
        // Click plus
        ...
        assertNotNull(uiDevice.wait(Until.findObject(By.desc("test")), 2000));
