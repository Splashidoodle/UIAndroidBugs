...
public class Script1641Feature2 {
    ...
    @Test
    public void scriptFeature1641_2() throws UiObjectNotFoundException {
        // Setup GUI actions
        // Click plus
        ...
        // Type 9
        uiDevice.findObject(new UiSelector().clickable(true).instance(3)).legacySetText("9");
        // Click back
        uiDevice.pressBack();
        // Click next
        ...
        UiObject2 trainingCheck = uiDevice.wait(Until.findObject(By.res("com.german_software_engineers.trainerapp:id/ScheduleInfo")), 2000);
        assert(trainingCheck.getText().contains("Repetitions: 9"));
