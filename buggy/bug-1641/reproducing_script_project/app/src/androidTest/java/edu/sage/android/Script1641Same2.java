...
public class Script1641Same2 {
    ...
    @Test
    public void scriptSame1641_2() throws UiObjectNotFoundException {
        // Setup GUI actions
        // Click plus
        uiDevice.findObject(new UiSelector().clickable(true).instance(2)).click();

        assertNotNull(uiDevice.wait(Until.findObject(By.text("strength endurance")), 2000));
    }
