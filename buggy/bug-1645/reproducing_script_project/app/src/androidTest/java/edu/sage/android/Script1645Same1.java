...
public class Script1645Same1 {
    ...
    @Test
    public void scriptSame1645_1() throws UiObjectNotFoundException {
        ...
        // Click checkbox 5
        uiDevice.findObject(new UiSelector().className("android.widget.CheckBox").instance(4)).click();
        // Click textbox 6
        uiDevice.findObject(new UiSelector().className("android.widget.EditText").instance(5)).click();
