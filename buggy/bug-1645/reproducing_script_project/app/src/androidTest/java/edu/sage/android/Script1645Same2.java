...
public class Script1645Same2 {
    ...
    @Test
    public void scriptSame1645_2() throws UiObjectNotFoundException {
        ...
        UiObject2 curScreen = uiDevice.wait(Until.findObject(By.text("8")), 2000);
