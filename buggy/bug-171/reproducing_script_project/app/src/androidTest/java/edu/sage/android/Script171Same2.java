...
public class Script171Same2 {
    ...
    @Test
    public void scriptSame171_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE,"select_text_htmltextview")), 2000));
