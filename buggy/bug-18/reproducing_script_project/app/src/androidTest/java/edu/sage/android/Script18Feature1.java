...
public class Script18Feature1 {
    ...
    @Test
    public void scriptFeature18_1() throws UiObjectNotFoundException {
        ...
        // Press routines option
        uiDevice.findObject(new UiSelector().clickable(true).instance(16)).click();

        UiObject2 breakfast = uiDevice.wait(Until.findObject(By.text("Breakfast")), 2000);
        breakfast.click();
        ...
        UiObject2 newRoutine = uiDevice.wait(Until.findObject(By.text("10:00")), 2000);

        assertNotNull(newRoutine);
    }
