...
public class Script18Feature2 {
    ...
    @Test
    public void scriptFeature18_2() throws UiObjectNotFoundException {
        ...
        assertNotNull(uiDevice.findObject(By.res(PACKAGE_NAME, "time_picker")));
    }
