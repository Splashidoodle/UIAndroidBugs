...
public class Script18Same1 {
    ...
    @Test
    public void scriptSame18_1() throws UiObjectNotFoundException {
        ...
        //click check
        uiDevice.click(907, 357);

        assertNotNull(uiDevice.wait(Until.findObject(By.text("No data")), 2000));
    }
