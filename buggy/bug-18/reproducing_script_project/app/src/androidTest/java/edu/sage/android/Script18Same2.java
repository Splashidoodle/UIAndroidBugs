...
public class Script18Same2 {

    private static final String PACKAGE_NAME
            = "es.usc.citius.servando.calendula.dev";
    ...
    @Test
    public void scriptSame18_2() throws UiObjectNotFoundException {
        // Perform setup GUI actions
        // Press right button five times
        ...
        // Press medicines option
        uiDevice.findObject(new UiSelector().clickable(true).instance(15)).click();
        // Press "+" button
        ...
        // Press capsules button
        uiDevice.findObject(new UiSelector().clickable(true).instance(2)).click();
        // Press tick button
        uiDevice.findObject(new UiSelector().clickable(true).instance(7)).click();

        // Preform bug-specific GUI actions
        // Press test medicine option
        uiDevice.findObject(new UiSelector().clickable(true).instance(9)).click();
        // Press edit button
        uiDevice.findObject(new UiSelector().clickable(true).instance(1)).click();
        // Press stock switch
        ...
        UiObject2 plus = uiDevice.wait(Until.findObject(By.res(PACKAGE_NAME, "btn_stock_add")), 2000);
        assertNotNull(plus);

        UiObject2 minus = uiDevice.wait(Until.findObject(By.res(PACKAGE_NAME, "btn_stock_remove")), 2000);
        assertNotNull(minus);
    }
