...
public class Script181Feature1 {
    ...
    @Test
    public void scriptFeature181_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertEquals(title, storyToFilter.getText());
    }
