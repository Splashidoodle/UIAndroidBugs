...
public class Script181Feature2 {
    ...
    @Test
    public void scriptFeature181_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        UiObject2 storyToFilter = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "story_meta")), 2000);
        String title = storyToFilter.getText();

        UiObject2 domainToFilter = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "story_meta")), 2000);
        String domain = domainToFilter.getText();
        ...
        UiObject2 filter = mDevice.wait(Until.findObject(By.text("Filter stories by domain")), 2000);
        filter.click();

        UiObject input = mDevice.findObject(new UiSelector().resourceId("android:id/edit"));
        input.setText(words[1]);
