...
public class Script192Same1 {
    ...
    @Test
    public void scriptSame192_1()throws RemoteException {
        ...
        UiObject2 finalCheck = mDevice.findObject(By.res(BASIC_SAMPLE_PACKAGE, "document__fragment__edit__highlighting_editor"));
        assertFalse(finalCheck.getText().contains("S12345"));
