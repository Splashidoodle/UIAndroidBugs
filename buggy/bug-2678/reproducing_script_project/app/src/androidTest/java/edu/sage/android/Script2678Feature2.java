...
public class Script2678Feature2 {
    ...
    @Test
    public void scriptFeature2678_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        three.click();
        UiObject2 point = mDevice.wait(Until.findObject(By.res("com.google.android.inputmethod.latin:id/key_pos_number_line4_3")),2000);
        point.click();
        UiObject2 eight = mDevice.wait(Until.findObject(By.res("com.google.android.inputmethod.latin:id/key_pos_number_line3_2")),2000);
        eight.click();


        assertNull(mDevice.wait(Until.findObject(By.text("3.8")), 2000));
    }
