...
public class Script2678Feature3 {
    ...
    @Test
    public void scriptFeature2678_3() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        //write -38 degrees
        UiObject2 dash = mDevice.wait(Until.findObject(By.res("com.google.android.inputmethod.latin:id/key_pos_number_line1_4")),2000);
        dash.click();
        ...
        assertNull(mDevice.wait(Until.findObject(By.text("-38")), 2000));
    }
