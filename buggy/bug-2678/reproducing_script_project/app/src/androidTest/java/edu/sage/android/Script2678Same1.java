...
public class Script2678Same1 {
    ...
    @Test
    public void scriptSame2678_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        //backspace
        UiObject2 back = mDevice.wait(Until.findObject(By.res("com.google.android.inputmethod.latin:id/key_pos_number_line3_4")),2000);
        back.click();
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.text("0")), 2000));
    }
