...
public class Script271Feature1 {
    ...
    @Test
    public void scriptFeature271_1() {
        ...
        try {
            ...
            String curOTP = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "profile_code")), 2000).getText();
            try {
                TimeUnit.MILLISECONDS.sleep(9000);
            } catch (InterruptedException e) {
                throw new RuntimeException(e);
            }
            String curOTP2 = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "profile_code")), 2000).getText();

            assertNotEquals(curOTP, curOTP2);
