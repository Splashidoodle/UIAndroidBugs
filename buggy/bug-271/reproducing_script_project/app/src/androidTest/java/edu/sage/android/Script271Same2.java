...
public class Script271Same2 {
    ...
    public void scriptSame271_2() {
        ...
        try {
            ...
            assertNotNull(mDevice.wait(Until.findObject(By.text("Error saving profile")), 2000));
