...
public class Script358Same1 {
    ...
    @Test
    public void scriptSame358_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        input.setText("https://example.com/?q=a");
        ...
        assertEquals("a", valList.get(2).getText());
    }
