...
public class Script365Same1 {
    ...
    @Test
    public void scriptSame365_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertEquals("com.trianguloy.urlchecker", mDevice.getCurrentPackageName());
    }
