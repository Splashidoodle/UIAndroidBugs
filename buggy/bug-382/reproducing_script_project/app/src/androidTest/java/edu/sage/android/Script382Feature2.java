...
public class Script382Feature2 {
    ...
    @Test
    public void scriptFeature382_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        UiObject2 domain = mDevice.wait(Until.findObject(By.text("Domain")), 3000);
        assertNull(domain);
    }
