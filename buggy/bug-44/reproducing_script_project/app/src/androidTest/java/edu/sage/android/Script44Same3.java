...
public class Script44Same3 {
    ...
    public void scriptSame44_3() {
        ...
        */
        ...
        UiObject2 check = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "detail_title")),2000);
        assert(check.getText().contains("tag"));
