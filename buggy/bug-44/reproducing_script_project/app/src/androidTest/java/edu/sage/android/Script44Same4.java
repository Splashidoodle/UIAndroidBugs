...
public class Script44Same4 {
    ...
    public void scriptSame44_4() {
        ...
        */
        ...
        Tag = mDevice.wait(Until.findObject(By.textStartsWith( "a (1)")),2000);
        Tag.click();
        ...
        UiObject2 check = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "detail_content")),2000);
        assertFalse(check.getText().contains("#a"));
