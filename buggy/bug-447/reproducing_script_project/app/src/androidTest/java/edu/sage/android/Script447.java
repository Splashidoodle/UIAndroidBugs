...
public class Script447 {
    ...
    @Test
    public void testScript447() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertFalse(input.getText().contains("reddit.com"));
