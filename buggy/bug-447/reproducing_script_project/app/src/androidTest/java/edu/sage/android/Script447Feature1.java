...
public class Script447Feature1 {
    ...
    @Test
    public void scriptFeature447_1() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.text("HTTP link. Consider using HTTPS.")), 2000));
    }
