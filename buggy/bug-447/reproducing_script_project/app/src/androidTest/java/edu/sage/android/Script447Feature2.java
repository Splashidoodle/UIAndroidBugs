...
public class Script447Feature2 {
    ...
    @Test
    public void scriptFeature447_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        assertNotNull(mDevice.wait(Until.findObject(By.text("Missing HTTP scheme.")), 2000));
    }
