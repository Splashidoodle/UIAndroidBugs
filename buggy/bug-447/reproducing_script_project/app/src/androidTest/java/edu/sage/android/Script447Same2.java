...
public class Script447Same2 {
    ...
    @Test
    public void scriptSame447_2() throws IOException, UiObjectNotFoundException, RemoteException {
        ...
        input.setText("https://www.raddit.com/");
        ...
        assertNull(mDevice.wait(Until.findObject(By.text("Reddit ➔ Teddit")), 2000));
    }
