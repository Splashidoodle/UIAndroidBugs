...
//    }
    ...
    @Test
    public void scriptFeature71_1() throws UiObjectNotFoundException {
        ...
        UiObject minUI = mDevice.findObject(new UiSelector().clickable(true).instance(1));
        minUI.click();
        ...
        assertNotNull(mDevice.findObject(By.pkg("com.google.android.inputmethod.latin")));
    }
