...
//    }
    ...
    @Test
    public void scriptSame71_2() throws UiObjectNotFoundException {
        ...
        assertNotNull(mDevice.findObject(By.desc("Display app list")));
        assertNotNull(mDevice.findObject(By.res(BASIC_SAMPLE_PACKAGE, "searchEditText")));
        assertNotNull(mDevice.findObject(By.res(BASIC_SAMPLE_PACKAGE, "menuButton")));
    }
