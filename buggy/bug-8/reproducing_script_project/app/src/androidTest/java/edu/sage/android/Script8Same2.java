...
public class Script8Same2 {
    ...
    @Test
    public void scriptSame8_2() throws UiObjectNotFoundException {
        // Setup GUI actions
        // Press ok button
        ...
        assertNull(uiDevice.wait(Until.findObject(By.text("Create payment")), 2000));
    }
